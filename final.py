...
Original file is located at
    https://colab.research.google.com/drive/1gW6_O36l8VF1ip63X8N4Ect6F6-dfWU5
"""
...
def calculate_final_sentiment(sentiment_distribution):
    ...
    if sentiment_distribution[max_sentiment] == 0:
        return f"The overall sentiment of {company_name}'s is neutral, with no strong positive or negative influence."
    elif max_sentiment == "Positive":
        return f"The latest news coverage of {company_name}'s is mostly positive. Potential stock growth expected."
    elif max_sentiment == "Negative":
        return f"The overall sentiment of {company_name}'s is negative. Caution is advised due to potential risks."
    else:
...
def text_to_speech(text, language='en'):
  ...
  tts = gTTS(text=text, lang=language)  # Corrected indentation: 4 spaces
...
def generate_output(company, max_articles=10):
    ...
    audio_filename = text_to_speech(translated_sentiment, language='hi')
